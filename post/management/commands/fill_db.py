...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        post_name = [
            ...
            {'name': 'программирование', 'short_desc': 'Искусство создания компьютерных программ',
             'post_text': '#python, #programmer', 'hub_category': 'разработка мобильных приложений', 'user_id': 'User_2'},
            {'name': 'программирование', 'short_desc': 'Искусство создания компьютерных программ',
            ...
            {'name': 'программирование', 'short_desc': 'Искусство создания компьютерных программ',
             'post_text': '#python, #programmer', 'hub_category': 'разработка мобильных приложений', 'user_id': 'User_3'},
            {'name': 'программирование', 'short_desc': 'Искусство создания компьютерных программ',
            ...
            {'name': 'программирование', 'short_desc': 'Искусство создания компьютерных программ',
             'post_text': '#python, #programmer', 'hub_category': 'разработка мобильных приложений', 'user_id': 'User_4'},
            {'name': 'программирование', 'short_desc': 'Искусство создания компьютерных программ',
